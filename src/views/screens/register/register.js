...
//           <Image
//             style={styles.logo}
//             source={require("../../../../assets/images/launch_screen2.png")}
//           />
//           <TextInput
//             style={styles.input}
//             placeholder="Ime"
...
//             </TouchableOpacity>
//             <TouchableOpacity onPress={printAlert3} style={styles.smallButton}>
...
//             </TouchableOpacity>
//             <TouchableOpacity onPress={printAlert2} style={styles.smallButton}>
//               <Text style={styles.info}>i</Text>
//             </TouchableOpacity>
//           </View>
//         </ScrollView>
  ...
  return (
    <View style={styles.container}>
      <Svg height={height} width={widht}>
        <Image
          href={require("../../../../assets/images/imageGalery/image5.png")}
          width={widht}
          height={height}
